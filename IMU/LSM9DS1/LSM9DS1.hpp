...
protected:	
	...
	Chimera::GPIO::GPIOClass_sPtr csPinXG;	/* Chip select for accelerometer/gyroscope */
	...
	void SPIwriteByte(const Chimera::GPIO::GPIOClass_sPtr& csPin, uint8_t subAddress, uint8_t data);
	...
	uint8_t SPIreadByte(const Chimera::GPIO::GPIOClass_sPtr& csPin, uint8_t subAddress);
	...
	uint8_t SPIreadBytes(const Chimera::GPIO::GPIOClass_sPtr& csPin,
		uint8_t subAddress, 
		uint8_t * dest,
		uint8_t count);
